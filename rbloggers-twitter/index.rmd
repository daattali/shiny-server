...
```{r interactive-load-pkgs, echo = FALSE}
library(DT)
library(ggvis)
library(plyr)
library(dplyr)
...
```{r interactive-table-author, fig.width=10, echo = FALSE}
if (show_interactive) {
  datatable(
    tweets_by_author,
    rownames = FALSE,
...
```{r interactive-table-tweets, fig.width=10, echo = FALSE}
if (show_interactive) {
  datatable(
...
```{r interactive-plot-top, fig.width=10, echo = FALSE}
if (show_interactive) {
